...
@Autonomous(name = "Ex-Katie", group = "LinearOpMode")

public class Exercise_Katie extends LinearOpMode {
...
public void squareOnLine2(){
   ...
   /* public void getBeaconColor() {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveBackwards(1.5, 1.5, 1);

        telemetry.addData(">>", "Time To Dance :smiley:  ");
        telemetry.update();
        ...
        driveForwards(0.5, 0.5, 1);

        driveBackwards(0.5, 0.5, 1);

        robot.motorShooter.setPower(1);

        sleep(2000);

        driveForwards(0, 1.5, 1);

        telemetry.addData(">>", "FINISHED :smiley:  ");
        telemetry.update();

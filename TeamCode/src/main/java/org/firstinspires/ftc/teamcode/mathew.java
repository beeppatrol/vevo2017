...
@Autonomous(name = "Daniel_Mercy_Matthew", group = "LinearOpMode")
public class mathew extends LinearOpMode {
boolean targetColor = true;

    HardwarePushbot robot = new HardwarePushbot();

    public static void main () {
        mathew dn = new mathew();
        dn.matthew();
    }

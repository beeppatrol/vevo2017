...
@Autonomous(name = "Ex-Michael", group = "LinearOpMode")

public class Exercise_Michael extends LinearOpMode {
...
public void squareOnLine2(){
   ...
   /* public void getBeaconColor() {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveForwards(1.6,1.6,1);
        telemetry.addData(">>", "Mark 4");
        telemetry.update();

        robot.motorShooter.setPower(1);
        sleep(1000);
        telemetry.addData("reached here: ", "5");
        updateTelemetry(telemetry);
        ...
        driveForwards(.5,-.5,1);
        telemetry.addData(">>", "Mark 7");
        telemetry.update();
        driveForwards(-1.6,1.6,1);
        telemetry.addData(">>", "Mark 8");
        telemetry.update();
        driveForwards(1.1,-1.1,1);
        telemetry.addData(">>", "Mark 9");
        telemetry.update();
